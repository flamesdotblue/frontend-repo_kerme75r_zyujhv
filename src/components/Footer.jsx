        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex items-end md:items-start">
            <div className="w-full rounded-2xl border border-slate-200 bg-white/70 backdrop-blur p-6 shadow-sm">
              ...
              <p className="mt-1 text-sm text-slate-600">Start your free 14-day trial. No credit card needed.</p>
              ...
              <p className="mt-2 text-xs text-slate-500 text-center">30-Day Money-Back Guarantee</p>
            </div>
          </div>
        </div>

        <div className="mt-10 border-t border-slate-200 pt-6 text-sm text-slate-600 flex flex-col sm:flex-row items-center justify-between">
