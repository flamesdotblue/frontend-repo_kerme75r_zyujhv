...
function FeatureIcon({ icon: Icon, title, desc }) {
  return (
    <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white/70 dark:bg-slate-900/60 backdrop-blur p-6 shadow-sm hover:shadow-md transition-shadow">
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <section id="features" className="py-16">
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-semibold text-slate-900 dark:text-white">Powerful Features for Modern Marketing</h2>
          <p className="mt-3 text-slate-600 dark:text-slate-300">Everything you need to create, customize, and schedule compelling content.</p>
        </div>
        ...
        <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
          <div className="flex items-center gap-2 text-slate-700 dark:text-slate-300"><Zap className="h-4 w-4 text-blue-600" /> Lightning Fast</div>
          <div className="flex items-center gap-2 text-slate-700 dark:text-slate-300"><Target className="h-4 w-4 text-violet-600" /> Highly Targeted</div>
          <div className="flex items-center gap-2 text-slate-700 dark:text-slate-300"><Palette className="h-4 w-4 text-teal-600" /> Style Matching</div>
          <div className="flex items-center gap-2 text-slate-700 dark:text-slate-300"><BarChart3 className="h-4 w-4 text-emerald-600" /> Performance Analytics</div>
        </div>
      </section>
      ...
      <section id="how-it-works" className="py-16">
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-semibold text-slate-900 dark:text-white">How It Works</h2>
        </div>
        ...
        <ol className="mt-10 grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            ...
            <li key={s.title} className="relative rounded-2xl border border-slate-200 dark:border-slate-700 bg-white/70 dark:bg-slate-900/60 backdrop-blur p-6 shadow-sm">
        ...
        <div className="mt-8 text-center">
          ...
          <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">No credit card required • 14-day free trial</p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-semibold text-slate-900 dark:text-white">Loved by Marketing Teams</h2>
        </div>
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={t.name}
              className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white/70 dark:bg-slate-900/60 backdrop-blur p-6 shadow-sm hover:shadow-md transition-all"
      ...
      <section id="pricing" className="py-16">
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-semibold text-slate-900 dark:text-white">Simple, Transparent Pricing</h2>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-slate-600 dark:text-slate-300">30-Day Money-Back Guarantee</p>
      </section>
    </div>
  );
}
...
function Stat({ label, value }) {
  return (
    <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white/70 dark:bg-slate-900/60 backdrop-blur p-6 shadow-sm">
...
function PricingCard({ title, price, subtitle, features, cta, highlight }) {
  return (
    <div
      className={`relative rounded-2xl border p-6 shadow-sm backdrop-blur bg-white/70 dark:bg-slate-900/60 ${
        highlight
          ? 'border-violet-300 dark:border-violet-500/50 ring-2 ring-violet-200/80 dark:ring-violet-500/20'
    ...
    >
      ...
      <div className="mt-1 text-3xl font-semibold text-slate-900 dark:text-white">{price}</div>
      ...
      <a
        ...
        className={`mt-6 inline-flex w-full items-center justify-center rounded-full px-5 py-3 shadow transition-shadow ${
          highlight
            ...
            : 'border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 hover:shadow'
        }`}
      >
        {cta}
      </a>
