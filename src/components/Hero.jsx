    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/60 px-3 py-1 text-xs text-slate-700 shadow backdrop-blur">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              ...
              <a
                href="#demo"
                className="inline-flex items-center gap-2 rounded-full border border-slate-300/70 bg-white/70 px-5 py-3 text-slate-800 backdrop-blur hover:bg-white"
              >
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3 text-sm text-slate-600">
              <span className="inline-flex items-center gap-2 rounded-full bg-white/60 px-3 py-1 backdrop-blur pointer-events-none">
          ...
          <div className="relative hidden lg:block">
            <div className="absolute -inset-20 bg-gradient-to-br from-blue-500/20 via-fuchsia-400/20 to-teal-300/20 blur-3xl rounded-full pointer-events-none" />
            <div className="relative aspect-[4/3] rounded-2xl bg-white/60 backdrop-blur-lg border border-white/50 shadow-xl overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="col-span-2 h-40 rounded-xl bg-slate-100/70 shadow-inner" />
                  <div className="h-40 rounded-xl bg-slate-100/70 shadow-inner" />
                  <div className="h-24 rounded-xl bg-slate-100/70 shadow-inner" />
                  <div className="col-span-2 h-24 rounded-xl bg-slate-100/70 shadow-inner" />
                </div>
              </div>
            </div>
          </div>
